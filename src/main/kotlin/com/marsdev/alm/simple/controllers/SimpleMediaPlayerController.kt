package com.marsdev.alm.simple.controllers
...
class SimpleMediaPlayerController : Controller(), MediaPlayerEventListener {
    ...
    override fun timeChanged(mediaPlayer: MediaPlayer?, newTime: Long) {
        println("timeChanged")
        Platform.runLater({
            duration.set(newTime.toDouble())
            progress.set(newTime.toDouble() / maxDuration.get())
        })
    }
    ...
    override fun lengthChanged(mediaPlayer: MediaPlayer?, newLength: Long) {
        ...
        Platform.runLater({ maxDuration.set(newLength.toDouble()) })
    }
